# subtitle strings for csub.py


MICRODVD_FAKESUB_0 = """{40}{160}Downloaded From www.AllSubs.org
...
MICRODVD_FAKESUB_1 = """{16858}{6905}si, amici miei...
{16906}{6953}La vera luce è invisibile.
{26954}{7001}Attraversate il corridoio delle ombre...
{37002}{7097}ed entrerete|nel mondo dei prescelti.
{47098}{7145}Rinunciate al dono della vista.
{55557146}{7217}So che ci sono degli scettici fra voi...
{667218}{7289}timorosi di condividere con noi|i morti della notte.
{777290}{7361}Siate coraggiosi.|Rinunciate al dono della vista.
{887362}{7433}Spalancate i vostri occhi.|Venite con noi.
"""

MICRODVD_FAKESUB_2 = """{7434}{7504}Aiutateci a costruire un mondo migliore.
{7505}{7600}{y:b}ll trita ossa proverà ancora|a spezzare I'acciaio...
{7601}{7720}{y:i}usando solo la forza|delle sue possenti braccia.
{7721}{7792}Per favore, signore e signori,|desidero silenzio assoluto...
{7793}{7840}{C:#234234}durante la dimostrazione.
{7841}{7912}{y:b}Devo chiedervi,|per la vostra sicurezza...
{7913}{7960}{y:i}di non guardarlo nell'occhio...
{7961}{8032}{y:b}perchè la sua|forza di concentrazione è tale che...
{8033}{8128}{y:u}potrebbe provocare|un'emmoraggia cerebrale...
{8129}{8176}a quelli più deboli di voi.
{8177}{8224}{y:s}Signor One, è pronto?|E ora, attenzione!
{8344}{8368}{C:$0000ff}Piccolo ladruncolo!
{8369}{8464}{C:$00dff}Rubare i soldi degli orfani.|Ti insegno io!
"""

MICRODVD_FAKESUB_FAIL_TIME_IF_NOT_B_3 = """\
{-7961}{8032}perchè la sua|forza di concentrazione è tale che...
"""

MICRODVD_FAKESUB_FAIL_TIME_IF_NOT_B_4 = """\
{8033}{-8128}potrebbe provocare|un'emmoraggia cerebrale...
"""
...
MICRODVD_FAKESUB_FAIL_SYNTAX_6 = """\
{8344}Piccolo ladruncolo!
{8369}{8464}Rubare i soldi degli orfani.|Ti insegno io!
"""

MICRODVD_FAKESUB_FAIL_SYNTAX_7 = """{8465}{8488}Lasciali andare!
